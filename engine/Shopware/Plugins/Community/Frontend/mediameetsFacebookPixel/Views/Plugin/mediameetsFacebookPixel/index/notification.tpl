...
{if isset($mediameetsFacebookPixel.config.status) && $mediameetsFacebookPixel.config.status === true && in_array($mediameetsFacebookPixel.config.privacyMode, ['optin', 'optout'])}
