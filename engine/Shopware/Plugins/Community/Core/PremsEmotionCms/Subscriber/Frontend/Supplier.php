...
class Supplier implements \Enlight\Event\SubscriberInterface {
  /**
  ...
  public function onFrontendPostDispatch(\Enlight_Event_EventArgs $arguments) {
    ...
    $id = (int) $request->getParam('sSupplier');

    $this->bootstrap->addTemplateAndSnippetDir();

    $emotionService = Shopware()->Container()->get('prems_emotion_cms.supplier');
