 ...
 */
namespace Shopware\PremsEmotionCms\Subscriber\Widgets;
...
class Emotion implements \Enlight\Event\SubscriberInterface {
  ...
  public static function getSubscribedEvents() {
    return array(
      'Enlight_Controller_Action_PostDispatchSecure_Widgets_Emotion' => 'onWidgetsPostDispatch',
    );
  }
   ...
   */
  public function onWidgetsPostDispatch(\Enlight_Event_EventArgs $arguments) {
    ...
    if (!$request->getParam('noFullscreen')) {
      return;
    }

    $emotions = $view->sEmotions;
    foreach($emotions as &$emotion) {
      $emotion['fullscreen'] = 0;
    }
    $view->sEmotions = $emotions;
  }
}