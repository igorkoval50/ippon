//{namespace name=backend/prems_emotion_cms/blog/view/grid}
//{block name="backend/blog/view/prems_emotion_cms/Grid"}
Ext.define('Shopware.apps.Blog.PremsEmotionCms.view.Grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.prems-emotion-cms-blog-grid',
    ...
    initComponent: function() {
        ...
        me.emotionStore = Ext.create('Shopware.apps.Blog.PremsEmotionCms.store.Emotion').load();
            ...
            rowEditor = Ext.create('Ext.grid.plugin.RowEditing', {
                ...
                listeners: {
                    ...
                    edit: function(editor, e) {
                        ...
                        Ext.Ajax.request({
                            url: '{url controller="PremsEmotionCmsBlog" action="updateEmotionBlog"}',
                            method: 'POST',
                            params: {
                                id: record.data.id,
    ...
    getToolbar: function () {
        ...
        me.addButton = Ext.create('Ext.button.Button', {
            ...
            handler: function() {
                ...
                Ext.Ajax.request({
                    url: '{url controller="PremsEmotionCmsBlog" action="createEmotionBlog"}',
                    method: 'POST',
                    params: {
            ...
            store: Ext.create( "Ext.data.Store",
                {
                    ...
                    data:
                        [
                            { id: 0, name: "{s name=grid/select/position_above_blog_description}{/s}" },
                            { id: 1, name: "{s name=grid/select/position_below_blog_description}{/s}" },
                        ...
                        store: Ext.create( "Ext.data.Store",
                            {
                                ...
                                data:
                                    [
                                        { id: 0, name: "{s name=grid/columns/position_above_blog_description}{/s}" },
                                        { id: 1, name: "{s name=grid/columns/position_below_blog_description}{/s}" },
    ...
    renderLayout: function( value, metaData, record ) {
        var me = this;
        if (value == 0) {
            return '{s name=grid/columns/position_above_blog_description}{/s}';
        } else if(value == 1) {
            return '{s name=grid/columns/position_below_blog_description}{/s}';
        } else if (value == 2) {
