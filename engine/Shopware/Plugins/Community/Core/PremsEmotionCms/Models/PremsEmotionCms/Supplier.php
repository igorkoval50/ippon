...
/**
 * @ORM\Entity
 * @ORM\Table(name="s_prems_emotion_cms_supplier")
 */
class Supplier extends ModelEntity
{
   ...
   * @ORM\JoinTable(name="s_prems_emotion_cms_supplier_emotions",
   *      joinColumns={
   *          @ORM\JoinColumn(
   *              name="main_id",
   ...
   * @ORM\JoinTable(name="s_prems_emotion_cms_supplier_suppliers",
   *      joinColumns={
   *          @ORM\JoinColumn(
   *              name="main_id",
   *              referencedColumnName="id"
