...
Ext.define('Shopware.apps.NewsletterManager.view.components.Article', {
    ...
    snippets: {
        ...
        'article_type': '{s name=article_type}Article type{/s}',
        'actions': '{s name=actions}Action(s){/s}',
        'ordernumber': '{s name=ordernumber}Article ordernumber{/s}',
        'name': '{s name=name}Article name{/s}',
        'typeComboBox': {
            'random': '{s name=article/combobox/random}Random{/s}',
            'top': '{s name=article/combobox/top}Top selling product{/s}',
            'new': '{s name=article/combobox/new}Newer product{/s}',
            'fix': '{s name=article/combobox/fix}Chosen product{/s}'
        }
    },
    ...
    createTypeStore: function () {
        ...
        return new Ext.data.ArrayStore({
            ...
            data: [
                [1, 'random', me.snippets.typeComboBox.random ],
                [2, 'top', me.snippets.typeComboBox.top ],
                [3, 'new', me.snippets.typeComboBox.new ],
                [5, 'fix', me.snippets.typeComboBox.fix ]
            ]
        });
    },
        ...
        return [
            {
                ...
                dataIndex: 'type',
                header: me.snippets.article_type,
                flex: 1,
                editor: {
                    xtype: 'combobox',
                    queryMode: 'local',
