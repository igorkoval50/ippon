...
// --- external config for netzpStaging
$netzpConfig = include('filemanager_config.php');
$auth_users = $netzpConfig['auth_users'];
$directories_users = $netzpConfig['directories_users'];
// ----------------------------------------------------
