...
class Cache implements SubscriberInterface
{
    ...
    {
        return [
            'Shopware_Plugins_HttpCache_ContextCookieValue' => 'onCreateContextCookieHash',
        ];
    }
     ...
     * @return string
     */
    public function onCreateContextCookieHash(EventArgs $args)
    {
        $session = $this->dependencyProvider->getSession();

        $isUserLoggedIn = $session->get('sUserId') ? 1 : 0;

        return $args->getReturn() . $isUserLoggedIn;
    }
}
