...
//{block name="backend/swag_promotion/view/detail//statistics"}
Ext.define('Shopware.apps.SwagPromotion.view.detail.Statistics', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.promotion-statistics',
    ...
    /**
     * Initializes the component, sets up toolbar and paging bar and and registers some events
     *
     * @return void
     */
        ...
        return [
            ...
            },
            {
                ...
                renderer: function (value, metaData, record) {
                    ...
                    if (rate != 0) {
                        return Ext.String.format("[0] (<i>[1]%)</i>", read, rate);
                    }
            ...
            },
            {
                ...
                renderer: function (value, metaData, record) {
                    ...
                    if (rate != 0) {
                        return Ext.String.format("[0] (<i>[1]%)</i>", clicked, rate);
                    }
