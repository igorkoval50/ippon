...
//{block name="backend/analytics/view/chart/promotion"}
Ext.define('Shopware.apps.Analytics.view.chart.Promotion', {
    extend: 'Shopware.apps.Analytics.view.main.Chart',
    alias: 'widget.analytics-chart-promotion',
    animate: true,
    shadows: true,
        ...
        this.series = [
            {
                ...
                label: {
                    ...
                    renderer: function (value) {
                        var numberRenderer = Ext.util.Format.numberRenderer('0.00'),
                            val = numberRenderer(value),
                            currencySign = me.store.proxy.reader.jsonData.analyticsCurrency.sign,
                            orders = 3;

                        if (currencySign == "&euro;") {
                            currencySign = "€";
                        }

                        return val + ' ' + currencySign;
                    },
                ...
                tips: {
                    ...
                    renderer: function (storeItem, barItem) {
                        ...
                        this.setTitle(name + ' : ' + turnover + ' {s namespace="backend/swag_promotion/snippets" name="turnover"}Turnover{/s}, ' + orders + ' {s namespace="backend/swag_promotion/snippets" name="orders"}orders{/s}');
                    }
                }
            }
        ];
