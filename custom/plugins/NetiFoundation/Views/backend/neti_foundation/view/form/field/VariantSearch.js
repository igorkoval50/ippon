...
//{$smarty.block.parent}
Ext.define('Shopware.form.field.NetiVariantSearch',
/** @lends Ext.container.Container# */
{
     ...
     * @array
     */
    alternateClassName: [ 'Shopware.form.NetiVariantSearch', 'Shopware.NetiVariantSearch' ],

    /**
     * List of short aliases for class names. Most useful for defining xtypes for widgets
     * @array
     */
    alias: [ 'widget.netivariantsearch', 'widget.netivariantsearchfield' ],
    ...
    requires: [
        ...
        'Shopware.apps.Base.store.NetiArticleVariant',
    ...
    /**
     * False to make the selection mandatory
     * @boolean
     */
    allowBlank: true,
    ...
    initComponent: function() {
        ...
        if (!(me.articleStore instanceof Ext.data.Store)) {
            me.articleStore = Ext.create('Shopware.apps.Base.store.NetiArticleVariant');
        }

        // We need to filter the store on loading to prevent to show the first article in the store on startup
        me.dropDownStore = Ext.create('Shopware.apps.Base.store.NetiArticleVariant', {
            listeners: {
                single: true,
                load: function() {
     ...
     * @public
     * @event datachanged
     * @param [object] store - passed Shopware.apps.Base.store.NetiArticleVariant
     * @return void
     */
