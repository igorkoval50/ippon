...
class ControllerPath implements SubscriberInterface
{
    ...
    {
        return [
            'Enlight_Controller_Dispatcher_ControllerPath_Backend_TlsNewsletterGroup' => 'onGetControllerPathBackend',
        ];
    }
    ...
    {
        return $this->pluginDir . '/Controllers/Backend/TlsNewsletterGroup.php';
    }
}
