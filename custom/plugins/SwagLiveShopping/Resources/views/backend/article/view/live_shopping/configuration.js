...
Ext.define('Shopware.apps.Article.view.live_shopping.Configuration', {
    ...
    createRightContainerItems: function() {
        ...
        items.push(me.createPurchaseItem());
    ...
    createLiveShoppingTypeItem: function() {
        ...
        me.liveShoppingTypeComboBox = Ext.create('Ext.form.field.ComboBox', {
            ...
            displayField: 'name',
            allowBlank: false,
            fieldLabel: '{s name=configuration/live_shopping_typ}Live shopping typ{/s}',
            listeners: {
    ...
    /**
     * Creates the max purchase number field.
     * Displayed in the right form panel container.
     * @return Ext.form.field.Number
     */
    createPurchaseItem: function() {
        var me = this;

        me.purchaseField = Ext.create('Ext.form.field.Number', {
            name: 'purchase',
            labelWidth: 155,
            labelStyle: 'font-weight: bold',
            fieldLabel: '{s name=configuration/max_purchase}Maximum purchase quantity{/s}',
            minValue: 0,
            decimalPrecision: 0
        });
