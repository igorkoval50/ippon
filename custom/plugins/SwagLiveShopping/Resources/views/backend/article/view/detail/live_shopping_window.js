...
Ext.define('Shopware.apps.Article.view.detail.LiveShoppingWindow', {
    ...
    createMainTabPanel: function() {
        ...
        me.registerAdditionalTab({
            title: 'LiveShopping',
            contentFn: me.createLiveShoppingTab,
            ...
            tabConfig: {
                ...
                listeners: {
                    activate: function () {
                        me.fireEvent('liveShoppingTabActivated', me);
                    },
                    deactivate: function () {
    ...
    /**
     * Callback function called when the product changed (split view).
     *
     * @param product
     */
    productChange: function(product) {
        ...
        me.liveShoppingListStore.getProxy().extraParams.articleId = product.get('id');
        me.liveShoppingListStore.load();
    },
     ...
     */
    createLiveShoppingTab: function(product, stores, eOpts) {
        var me = this,
            tab = eOpts.tab;
        ...
        tab.add(me.createLiveShoppingComponents());
        tab.setDisabled(product.get('id') === null);
    },

    /**
     * Creates all components for the live shopping tab which displayed in the product detail window.
     * @return Array
     */
    ...
    /**
     * Creates the listing component which displays all live shoppings of the current product
    ...
    /**
     * Creates the tab panel item for the live shopping stints.
     * @return Shopware.apps.Article.view.live_shopping.tabs.Shop
     */
