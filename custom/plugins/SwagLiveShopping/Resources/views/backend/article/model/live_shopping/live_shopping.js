...
Ext.define('Shopware.apps.Article.model.live_shopping.LiveShopping', {
    ...
    fields: [
        ...
        { name: 'purchase', type: 'int', defaultValue: false },
        { name: 'validFrom', type: 'date', useNull: true, dateFormat: 'd.m.Y' },
        { name: 'validTo', type: 'date', useNull: true, dateFormat: 'd.m.Y' },
        { name: 'validFromTime', type: 'date', useNull: true, dateFormat: 'H:i' },
        { name: 'validToTime', type: 'date', useNull: true, dateFormat: 'H:i' },
    ...
    associations: [
        ...
        },
        {
            ...
            name: 'getLimitedVariants',
            associationKey: 'limitedVariants'
        },
        {
            type: 'hasMany',
            model: 'Shopware.apps.Article.model.live_shopping.Price',
            name: 'getPrices',
