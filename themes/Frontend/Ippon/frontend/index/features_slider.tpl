{* Config *}
{block name="frontend_common_features_slider_config"}
    ...
    {$sliderInfiniteSlide = ($sliderInfiniteSlide)?$sliderInfiniteSlide:""}
{/block}

{* Template *}
{block name="frontend_common_features_slider_component"}
    <div class="features--slider {$productSliderCls}"
        ...
        {if $sliderInfiniteSlide}data-infiniteSlide="{$sliderInfiniteSlide}"{/if}
        data-product-slider="true">

        {block name="frontend_common_features_slider_container"}
            <div class="features-slider--container product-slider--container">
                {include file="frontend/index/features_slider_items.tpl"}
            </div>
        {/block}
