    ...
    $.plugin('swCollapseCart', {
        ...
        registerEvents: function () {
            ...
            if (me.isDisplayMode('offcanvas')) {
                ...
                $.subscribe(me.getEventName('plugin/kssAddArticle/onAddArticle'), $.proxy(me.onArticleAdded, me));
                $.subscribe(me.getEventName('plugin/kssAddArticle/onBeforeAddArticle'), $.proxy(me.onBeforeAddArticle, me));
            } else {
