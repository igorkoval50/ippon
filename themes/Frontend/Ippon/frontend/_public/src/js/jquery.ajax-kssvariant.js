;(function ($, window) {
    ...
    $.plugin('kssAjaxVariant', {
        ...
        init: function () {
            ...
            this.$el
                .on(this.getEventName('change'), '*[data-ajax-select-kss-variants="true"]', $.proxy(this.onChange, this));
        ...
        requestData: function (values, pushState) {
            ...
            $.publish('plugin/kssAjaxVariant/onBeforeRequestData', [me, values, stateObj.location]);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.publish('plugin/kssAjaxVariant/onRequestData', [me, response, values, stateObj.location]);

                    if (pushState && me.hasHistorySupport) {
                        me.pushState(stateObj, ordernumber);
                        $.publish('plugin/kssAjaxVariant/onHistoryChanged', [me, response, values, stateObj.location]);
                    }
                },
                complete: function (response, status) {
                    $.loadingIndicator.close();
                    $.publish('plugin/kssAjaxVariant/onRequestDataCompleted', [me, response, status, values, stateObj.location]);
                }
            });
        },
        ...
        onPopState: function (event) {
            ...
            $.publish('plugin/kssAjaxVariant/onPopState', [this, state]);
        ...
        onChange: function (event) {
            ...
            $.publish('plugin/kssAjaxVariant/onChange', [this, values, $target]);
