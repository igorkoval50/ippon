;(function ($, window) {
     ...
     * HTML:
     *
     * <form data-add-kssarticle="true" data-eventName="submit">
     ...
     * JS:
     *
     * $('*[data-add-kssarticle="true"]').kssAddArticle();
     *
     */
    $.plugin('kssAddArticle', {
        ...
        sendSerializedForm: function (event) {
            ...
            $.publish('plugin/kssAddArticle/onBeforeAddArticle', [me, ajaxData]);
            ...
            $.ajax({
                ...
                success: function (result) {
                    $.publish('plugin/kssAddArticle/onAddArticle', [me, result]);
                    ...
                    $.loadingIndicator.close(function () {
                        ...
                        $.publish('plugin/kssAddArticle/onAddArticleOpenModal', [me, result]);
                    });
                }
            });
        },
        ...
        closeModal: function (event) {
            ...
            $.publish('plugin/kssAddArticle/onCloseModal', [this]);
        },
