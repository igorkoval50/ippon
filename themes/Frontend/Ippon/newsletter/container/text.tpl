...
<table width="560" border="0" cellspacing="10" cellpadding="0" style="color:#494949; line-height:17px;font-family:Arial,Helvetica;font-size:13px; padding:15px 0; width:560px; background-color: #fff;">
  <tr>
    <td>
    ...
    {include file="string:{$sCampaignContainer.data.html|replace:'<h2':'<h2 style="font-size:13px;color:#e20612; text-transform:uppercase;line-height:14px;" '}"}
    </td>
  </tr>
</table>
...
{else}
    ...
    <tbody style="margin:0;padding:0;">
      <tr>
       ...
       <td height="120" valign="top" style="padding:0px;font-size:11px;color:#e20612;">
